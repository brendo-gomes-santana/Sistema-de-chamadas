                ...
                <section className='container'>
                    <form className='form-profile' onSubmit={handleRegister}>
                        ...
                        {loadCustomers ? (
                            ...
                            <select value={custome} onChange={ v => setCustome(v.target.value)}>
                                <option> Selecione o cliente </option>
                                {customers.map((cliente)=> {
                                    return(
                                        <option key={cliente.id} value={cliente.nomeFantasia}>{cliente.nomeFantasia}</option>
                                    )
                                }
                                )}
                            </select>
                        ...
                        <label>Assunto</label>
                        <select value={ assunto } onChange={ v => setAssunto(v.target.value)}>
                        ...
                        <div className='status'>
                            ...
                            checked={ status === 'Aberto'}/> <span>Em aberto</span>

                            <input type="radio" 
                            name='radio' value="Progresso" 
                            onChange={handleOptionChange}
                            checked={ status === 'Progresso'}/> <span>Progresso</span>

                            <input type="radio" 
                            name='radio' value="Atendido" 
                            onChange={handleOptionChange}
                            checked={ status === 'Atendido'}/> <span>Atendido</span>
                        </div>
